...
public final class Quote {
    ...
    /**
     * Creates new Quote object from the value following the pattern storeNome:price:discountCode
     * @param value containing storenome:price:discountCode

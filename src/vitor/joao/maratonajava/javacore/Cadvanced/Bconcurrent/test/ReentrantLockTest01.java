...
class Worker implements Runnable {
    ...
    @Override
    public void run() {
        // Adendo: toda vez que obter o lock, temos que garantir que ele será fechado pelo unlock.

        lock.lock();
        try {
            // isHeldByCurrentThread() vai verificar se o lock está nas mãos da thread que está
            // executando esse código agora.

...
// Locale Object lesson
public class LocaleTest01 {
    public static void main(String[] args) {

        // Formatar datas, moedas e números baseada na localização da JVM do usuário.
        // Exemplo do padrão ISO: pt-BR
        ...
        // Exibindo o label do País que nós criamos esse local.
        // Exbide de acordo com o que temos no S.O por padrão.
